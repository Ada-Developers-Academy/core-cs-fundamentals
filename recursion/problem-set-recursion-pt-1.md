...
*Note: Parentheses are considered nested if and only if you can divide the string in two and the right side only consists of opening parentheses and the left side only consists of closing parentheses. As a result, the final example here fails.
